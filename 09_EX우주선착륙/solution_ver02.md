```cpp
/*
47_EX우주선착륙_user_ver02


[해결 전략 2]
* [해결전략1] 에서 각 그룹별 최대점수를 계산할 때, 우주선 재고를 고려하면서 처리하기.
				   <ver01>    <ver02>
seed :   5  SCORE: 3001673
seed :  32  SCORE: 3011024 => 3011261
seed : 176  SCORE: 3022040 => 3022226
PASS
...
void dfs(int step, int scoreSum, int bit) {
	...
	// 1. landID를 사용하는 경우
	if (isAble(lands[landID]) && (hwLen[h][w] || hwLen[w][h])) {  // ##### 우주선 재고를 고려하여 선택하기
